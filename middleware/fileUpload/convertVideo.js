...
//     const sourcePath = path.join(__dirname, `../../uploads/videos/${req.file.filename}`);
//     const hlsOutputPath = path.join(__dirname, `../../uploads/videos/hls/${req.file.filename}`);
